import React, { useState, useEffect, useContext } from "react"; //Creamos esta screen (copia pega de ./Home.js) -> Route en App.js., e importamos allí esta screen s
...
const Home = () => {
  ...
  useEffect(() => {
    fetch("/getsubpost", {
      //Makeamos una request a post.js\routes router.get('/getsubpost'..
      headers: {
      ...
      {data.map((item) => {
        return (
          <div className="card home-card" key={item._id}>
            {/* Aquí se indica el nombre de quien creó el post (por duplicado en este caso). Añadimos la papelera con el delete al lado. Y lo linkeamos a la ruta de App.js. Le damos un padding */}
